...
const SignIn = () => {
  ...
  return (
    <div
      className="w-full h-[100vh] flex justify-center items-center bg-cover bg-center relative"
    ...
    >
      ...
      <form
        className="relative w-[90%] h-auto max-w-[420px] bg-gradient-to-b from-[#0f0f1a]/90 to-[#1b1b2f]/90 
      ...
      >
        <h1 className="text-white text-3xl font-bold mb-6 text-center tracking-wide">
          Welcome Back
          <br />
        ...
        <div className="w-full">
          <input
            ...
            className="w-full h-[55px] outline-none border border-cyan-400/40 bg-transparent text-white placeholder-gray-400 px-5 rounded-xl 
