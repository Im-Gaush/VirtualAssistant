...
const SignIn = () => {
  ...
  return (
    ...
    >
      <form className="w-[90%] h-[600px] max-w-[500px] bg-[#0000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]" onSubmit={handleSignIn}>
        <h1 className="text-white text-[30px] font-semibold mb-[30px]">
          SignIn to <span className="text-yellow-400">Virtual Assistant</span>
        </h1>
        ...
        <p className="text-white " onClick={()=>nevigate('/signup')}>Create an account ? <span className="text-blue-950 cursor-pointer">Sign Up</span></p>
      </form> 
    </div>
  );
};
